...
const swiper = new Swiper(
    '.swiper-container',
    {
        loop: true,//возвращение к началу
        navigation: { //без navigation не работают кнопки
...
function renderCards(data) {
    ...
    longGoodList.append(...cards);//убираем квадратные скобки и все элементы друг за другом добавляются
...
//mouseup - для случая, когда случайно чуть не закрыл модальное окно
