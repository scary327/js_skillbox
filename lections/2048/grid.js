...
export class Grid {
    constructor(gridElement) {
        ...
        this.groupedCellsByReversedColumn = this.groupedCellsByColumn.map(column => [...column].reverse());//клон массива
        this.groupedCellsByRow = this.groupCellsByRow = this.groupCellsByRow();
        this.groupedCellsByReversedRow = this.groupCellsByRow.map(row => [...row].reverse());
    }
